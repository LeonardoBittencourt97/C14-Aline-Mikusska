      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="font-body text-sm sm:text-base text-[var(--text-muted)] max-w-xl mx-auto leading-relaxed">
            Respostas diretas e esclarecedoras para as principais dúvidas de quem busca assessoria jurídica em Família, Cível, Criminal e Previdenciário.
          </p>
        </div>
        ...
        >
          ...
          <p className="font-body text-xs sm:text-sm text-[var(--text-muted)] max-w-md mx-auto mb-5 leading-relaxed">
            Cada caso possui particularidades que exigem análise sob medida. Envie uma mensagem no WhatsApp para uma conversa inicial direta com a Dra. Aline.
          </p>
          <a
