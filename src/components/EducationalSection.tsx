...
export function EducationalSection() {
  ...
  const getWhatsAppMessageUrl = (topicTitle: string) => {
    const text = `Olá, Dra. Aline! Li o conteúdo educativo sobre "${topicTitle}" no seu site e gostaria de saber mais a respeito do meu caso.`;
    return `https://wa.me/${OFFICE_INFO.whatsapp}?text=${encodeURIComponent(text)}`;
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="font-body text-sm sm:text-base text-[var(--text-muted)] max-w-xl leading-relaxed">
            Orientações e esclarecimentos elaborados com finalidade puramente pedagógica e de interesse social, em cumprimento ao Provimento 205/2021 do CFOAB.
          </p>
        </div>
              ...
              <div className="pt-6 border-t border-[var(--border-subtle)]/20 flex flex-col sm:flex-row items-center justify-between gap-4">
                <div className="text-center sm:text-left">
                  ...
                  <span className="text-xs text-[var(--text-muted)] font-body">
                    Converse diretamente com a Dra. Aline Pacheco Mikusska
                  </span>
                </div>
